...
<body>
    <div class="header">
        ...
        <p>Peroni Karya Sentra Finance & Energy Management System</p>
    </div>
        ...
        <tbody>
            ...
            @foreach($reports as $row)
                ...
                <tr>
                    ...
                    <td class="text-right" style="font-size: 9px; color: #666;">{{ number_format($row->applied_rate, 2) }}
                    </td>
                    <td class="text-right font-bold">Rp {{ number_format($row->energy_cost, 0) }}</td>
                    <td class="text-center">
                        <span
                            style="font-size: 8px; padding: 2px 4px; border: 1px solid #ccc; border-radius: 2px; background: #f5f5f5; color: #666; font-weight: bold;">
